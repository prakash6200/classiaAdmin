    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0f]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div 
          ...
          style={{
            background: 'conic-gradient(from 180deg, transparent, #00004D, #d7b56d, transparent)',
        ...
        {[...Array(6)].map((_, i) => (
          <div
            ...
            style={{
              height: '200%',
              background: 'linear-gradient(180deg, transparent, #d7b56d, transparent)',
              left: `${15 + i * 15}%`,
              top: '-50%',
        ...
        {[...Array(10)].map((_, i) => (
          <div
            ...
            style={{
              ...
              borderColor: i % 3 === 0 ? '#d7b56d' : '#00004D',
              borderWidth: '2px',
              borderRadius: i % 2 === 0 ? '50%' : '8px',
              animation: `spin-float ${15 + Math.random() * 20}s linear infinite`,
              animationDelay: `${Math.random() * 5}s`,
            }}
          />
        ))}
        ...
        <div 
          className="absolute inset-0"
          style={{
            background: 'radial-gradient(circle at 50% 50%, rgba(215,181,109,0.1) 0%, transparent 50%)',
